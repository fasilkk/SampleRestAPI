...
class ContactController extends ApiController {
    ...
    function __construct( ContactGroupForm $contactGroupFormValidation , ContactForm $contactFormValidation , GroupDataMapper $groupDataMapper , ContactDataMapper $contactDataMapper )
    {
    ...
    public function index()
    {
        ...
        if ( $user->groups != null )
            ...
            return $this->responseSuccessWithOnlyData(array());
    ...
    public function contactIndex()
    {
        ...
        try
        {
            ...
            return $this->responseWithError(array('numbers[]' => 'Enter Valid Numbers'));
        ...
        if ( $group->user->id == $user->id )
        {
            ...
            try
            {
                if ( is_array($inputs['numbers']) )
                {
                    ...
                    else if ( $deleteFlag < count($inputs['numbers']) )
